...
async function main() {
  try {
    ...
    console.log('The job will call the mock target server at:', MOCK_TARGET_URL);
    console.log('Check the mock target server logs to see the incoming request.');
    ...
    if (response.data.error_message) {
      ...
      console.log('Job has not been executed yet. It might be delayed or there might be an issue.');
    }
  } catch (error) {
