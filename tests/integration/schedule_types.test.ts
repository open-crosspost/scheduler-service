...
describe("Job Schedule Types", () => {
  ...
  test("should create a job with cron schedule and execute it", { timeout: 70000}, async () => {
  ...
  test("should create a job with recurring schedule and execute it", { timeout: 70000 }, async () => {
    // Set up a mock target server
    const targetUrl = "http://mock-target.com";
